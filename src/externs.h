...
extern errr option_dump_pref_file(cptr name);
extern errr macro_dump_pref_file(cptr name);
extern errr keymap_dump_pref_file(cptr name);
extern errr color_dump_pref_file(cptr name);
...
extern bool scenario_pending_map_generation(void);
extern bool scenario_generate_pending_map(void);
